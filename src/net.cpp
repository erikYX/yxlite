...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "YXlite " + FormatFullVersion();
...
//    {"yxlitetools.com", "dnsseed.yxlitetools.com"},
//    {"yxlitepool.org", "dnsseed.yxlitepool.org"},
...
//    {"yxlitetools.com", "testnet-seed.yxlitetools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. YXlite is probably already running."), addrBind.ToString().c_str());
        else
