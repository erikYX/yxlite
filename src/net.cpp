...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "YXcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"yxcointools.com", "dnsseed.yxcointools.com"},
    {"yxcoinpool.org", "dnsseed.yxcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"yxcointools.com", "testnet-seed.yxcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. YXcoin is probably already running."), addrBind.ToString().c_str());
        else
